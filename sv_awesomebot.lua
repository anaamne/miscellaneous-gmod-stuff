...
leBotConfig = {
    ...
    activities = {
        ...
        "Running",
        "Going on a hike",
        "Writing book or story",
        "Starting instagram page for pet",
        "Brain strengthing",
        "Coloring",
        "Writing stuff in journal",
        "Heading to library",
        "Going to garden",
        "Going on a run",
        "Starting herb",
        "Starting garden",
        "Plant watering",
        "Writing thank you cards for business contact",
        "Writing letter for future self",
        "Organizing",
        "Learning proper foot massage",
        "Watching funny cat videos",
        "Organizing sleeping schedule",
        "Gratitude list making",
        "Swimming",
        "Googling myself",
        "Googling anything",
        "Offer help for colleagues friends",
        "Starting a book club with people",
        ...
        "Singing",
        "Listening to music",
        "Making bird feeders and installing",
        "Planning",
        "Planning and preparing to invade area 51 with others",
        "Going on a picnic",
        "Lunch time",
        "Free week at new gym",
        "Starting a herb",
        "Becoming a vegan",
        "Getting vaccinated",
        "Testing for virus",
        ...
        "Organize books",
        "Washing cloth",
        "Seperate white and the black people",
        "Organize coat closest",
        "Replace toilet paper",
        "Clean toilet",
        "Clean tub",
        "Peeling food",
        "Making salad",
        "Making toast and serving",
        "Making food serve to people",
        "Making food",
        "Pet caring",
        "Pet feeding and giving water",
        "Walking the dog",
        "Brush pets",
        "Give pets bath",
        "Wipe baseboards",
...
leBotCommands = {
    ...
    dox = function(args)
        ...
        timer.Simple(math.random(2, 6), function()
            local gender = leCoinFlip() and "Male" or "Female"
            local name = table.Random(leBotConfig.dox.names.first[string.lower(gender)]) .. " " .. table.Random(leBotConfig.dox.names.last)

            local sections = leSplitString("Fake Info: Real Name: " .. name .. ", Age: " .. math.random(5, 21) .. ", Gender: " .. gender .. ", IP: " .. string.format("%d.%d.%d.%d", math.random(10, 255), math.random(10, 255), math.random(10, 255), math.random(10, 255)) .. ", Cash: $" .. math.random(10, 100) .. "." .. math.random(10, 99) .. ", Height: " .. math.random(4, 6) .. " ft " .. math.random(1, 11) .. " inches")
    ...
    word = function()
        leBotSay(table.Random(leBotConfig.words))
    end,
    ...
    fakeinfo = function()
        ...
        local sections = leSplitString("Name: " .. name .. ", Gender: " .. gender .. ", Age: " .. math.random(18, 72) .. ", Job: " .. table.Random(leBotConfig.jobs) .. ", Cash: $" .. math.random(1, 1000) .. "." .. math.random(10, 99) .. ", Doing: " .. table.Random(leBotConfig.activities) .. ", Status: " .. table.Random(leBotConfig.feelings))
